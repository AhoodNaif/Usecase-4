...
app = FastAPI()
model = joblib.load(r'C:\Users\ohoud\OneDrive\Desktop\Tuwaiq\Usecase-4\ML\SL\Classification\knn_model.joblib')
scaler = joblib.load(r'C:\Users\ohoud\OneDrive\Desktop\Tuwaiq\Usecase-4\ML\SL\Classification\scaler.joblib')
 # GET request
@app.get("/")
def read_root():
